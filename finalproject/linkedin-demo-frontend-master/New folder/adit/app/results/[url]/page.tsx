...
export default function ResultsPage() {
  ...
  useEffect(() => {
    if (isSuggestSuccess && suggestData?.suggestions) {
      ...
      console.log("Fetched data:", suggestData.suggestions)
  ...
  useEffect(() => {
    if (suggestions && selectedCategory && suggestData) {
      // Pass the whole query to searchDocumentsAttachment instead of just parts
      searchDocs(suggestData, {
        onSuccess: (data) => {
  ...
  }, [suggestions, selectedCategory, searchDocs, suggestData])
